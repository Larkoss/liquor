...
<body>
  ...
  <div class="copyright text-center bg-dark text-white py-2">
    <p class="font-rale font-size-14">&copy; Copyrights 2022. Desing By <a
        href="https://www.cs.ucy.ac.cy/~klarko01/portfolio/" class="color-second">Larkos Konstantinos</a></p>
  </div>
  <!-- !start #footer -->
